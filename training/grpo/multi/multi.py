...
OUTPUT_FILE = f"./grpo_cpt_sft_multi_seed{SEED}_results.csv"
FINAL_MODEL_DIR = f"./grpo_cpt_sft_multi_seed{SEED}_model"
...
if __name__ == "__main__":
    ...
    sim_count = 0
    pbar = tqdm(total=NUM_STEPS, desc="GRPO CPT+SFT (Multi)")
    ...
    print("✅ CPT+SFT Multi GRPO Complete!")